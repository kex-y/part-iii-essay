...
them for which which are studied further in subsequent sections. 
...
of \(\mu\) if \(\mu\) is log-concave (namely we will show \eqref{L3} for this special case), and prove 
