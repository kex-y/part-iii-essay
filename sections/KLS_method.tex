...
We will in this section provide a description of the stochastic localization scheme introduced by 
Eldan \cite{Eldan_2013} and describe its application in reducing (up to a logarithmic factor) the 
KLS conjecture into the thin-shell conjecture, i.e. we will describe a proof of theorem~\ref{thm:KLS_to_TS}.

As a high level overview, given a measure, the stochastic localization scheme constructs a measure-valued martingale
...
based on the method as described by \cite{Lee_2016}. Furthermore, by making small modifications to this 
method, we will also present the main result of \cite{Lee_2016}.
