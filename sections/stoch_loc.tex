...
We recall that the KLS conjecture states the existence of a universal (independent of dimension) bound 
for the concentration of any log-concave measures, i.e. existence of some \(C\) such that, 
\[\text{Var}\]