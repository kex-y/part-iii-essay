...
martingale as described above and in particular, by recalling corollary~\ref{cor:lim_dis}, 
...
\end{align*}
where the second equality follows as \(\mathbb{E}[M_t] = \mathbb{E}[M_\infty] = \mathbb{E}_\mu[\phi] = 0\).
