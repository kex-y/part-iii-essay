As an application of stochastic localizations, we will in this section introduce the KLS and thin-shell 
conjectures and by leveraging the linear-tilt localization, reduce the KLS conjecture (up to a 
logarithmic factor) into the thin-shell conjecture, i.e. we will describe a proof of theorem~\ref{thm:KLS_to_TS}.
