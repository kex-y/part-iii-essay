...
we will in the subsequent sections bound the log-Sobolev constant for log-concave measures 
...
\(\rho_{\gamma^n} = 1\). However, in contrast to the Poincaré inequality where 
...
Unfortunately, this approach cannot result in a log-Sobolev inequality as the Lipschitz condition on \(\phi\) is 
